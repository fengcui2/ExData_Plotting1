...
plot(my_time_new, Global_active_power, type="n", ylab = "Global Active Power", xlab = "", cex.axis = 0.8, cex.lab = 0.8)
lines(my_time_new, Global_active_power, type = "l")

plot(my_time_new, Voltage, type="n", ylab = "Voltage", xlab = "datetime", cex.axis = 0.8, cex.lab = 0.8)
lines(my_time_new, Voltage, type = "l")

plot(my_time_new, Sub_metering_1, type="n", ylab = "Energy sub metering", xlab = "", cex.axis = 0.8, cex.lab = 0.8)
...
legend("topright", lty = c(1, 1, 1), lwd = c(0.2, 0.2, 0.2), col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), cex = 0.6, bty = "n")	

plot(my_time_new, Global_reactive_power, type="n", ylab = "Global_reactive_power", xlab = "datetime", cex.axis = 0.8, cex.lab = 0.8)
